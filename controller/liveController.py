...
class LiveController:
    ...
    def __init__(self, belongs):
        ...
        if self.Belongs == 'hololive':
            self._VIEWER = 30000    # 通知トリガー 視聴者が30000人を超えたら通知する
            self._DIVISION_VIEWER = 30000   # 視聴者を30000で割った整数値を使用して通知判断に使用
        ...
        # logging
        self.logger = log.get_module_logger(__name__, self._LOG_FILE)
    ...
    def getLiveTag(self, ID:str)->str:
        ...
        # 絵師
        elif ID == 'UCt30jJgChL8qeT9VPadidSw' : HoloName,live_tag = 'しぐれうい', '#ういの校内放送'
        # のりプロ
    ...
    def live(self, notice_times:dict):
        self.logger.info('Start Live Controller')
